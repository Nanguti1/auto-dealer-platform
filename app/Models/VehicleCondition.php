...
/**
 * Reference Data Model - Vehicle Conditions
 *
 * NOTE: This model does not have a policy because it is not accessible through
 * the web interface. Vehicle conditions are managed through database seeders and
...
class VehicleCondition extends Model
{
    ...
    {
        return $this->hasMany(Vehicle::class, 'vehicle_condition_id');
    }
}
