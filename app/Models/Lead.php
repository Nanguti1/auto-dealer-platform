...
class Lead extends Model
{
    ...
    protected $fillable = ['crm_stage_id', 'assigned_user_id', 'vehicle_id', 'source', 'status', 'first_name', 'last_name', 'email', 'phone', 'budget', 'last_contacted_at', 'priority', 'score', 'notes'];
