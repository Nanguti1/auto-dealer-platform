...
export default function Create({ users, lenders, vehicles }: { users: Array<{ id: number; name: string; email?: string }>; lenders: Array<{ id: number; name: string }>; vehicles: Array<{ id: number; name: string; make: string; model: string; year: number; price: number }> }) {
  return (
