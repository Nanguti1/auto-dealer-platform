...
import { ArrowLeft, MapPin, Mail, Phone, Building2, Users, Car, BadgeCheck, XCircle, Pencil } from 'lucide-react';
...
export default function Show({ branch }: { branch: Branch }) {
  return (
    <BranchShell title={branch.name} description={`Branch code: ${branch.code}`} actions={
      <div className="flex gap-2">
        <BranchBackButton />
        <Button asChild>
          <Link href={admin.branches.edit(branch.id).url}>
