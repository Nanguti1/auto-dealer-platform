...
export default function Index({ stages = [], leads = [] }: { stages?: CrmStage[]; leads?: LeadRecord[] }) {
  ...
  return (
    <CrmShell title="Sales Pipeline" description="Kanban-style pipeline view grouped by backend CRM stages." actions={<Button asChild><Link href={adminRoutes.leads.create().url}>Create Lead</Link></Button>}>
