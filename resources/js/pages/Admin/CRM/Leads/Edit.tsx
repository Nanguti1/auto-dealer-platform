...
export default function Edit({ lead, vehicles, users, crmStages }: { lead: LeadRecord; vehicles: Array<{ id: number; name: string; make: string; model: string; year: number; price: number }>; users: Array<{ id: number; name: string; email?: string }>; crmStages: Array<{ id: number; name: string }> }) {
  return (
