...
export interface Promotion { id: number; name?: string; title?: string; slug?: string; type?: string; value?: string | number; discount?: string | number; description?: string; banner?: string; banner_path?: string; starts_at?: string; ends_at?: string; status?: string; visibility?: string; is_active?: boolean; rules?: Record<string, unknown> | null; vehicles?: MarketingVehicle[]; featured_vehicles?: MarketingVehicle[]; created_at?: string; updated_at?: string; [key: string]: unknown }
