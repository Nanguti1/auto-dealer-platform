...
export interface HeroSlider { id: number; title?: string; subtitle?: string; image_path?: string; cta_button_text?: string; cta_button_url?: string; display_order?: number; is_active?: boolean; is_published?: boolean; created_at?: string; updated_at?: string; [key: string]: unknown }
export interface HomePageSection { id: number; section_type?: string; title?: string; content?: Record<string, unknown>; display_order?: number; is_visible?: boolean; created_at?: string; updated_at?: string; [key: string]: unknown }
...
export interface SeoSettings { id?: number; site_name?: string; site_description?: string; default_meta_title?: string; default_meta_description?: string; canonical_url?: string; og_image?: string; twitter_handle?: string; robots_directive?: string; sitemap_enabled?: boolean; structured_data?: Record<string, unknown>; [key: string]: unknown }
