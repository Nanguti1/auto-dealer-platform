...
export interface AdminVehicle { id: number; title?: string; stock_number?: string; vin?: string; year?: number; sale_price?: string | number; msrp?: string | number; mileage?: number; is_featured?: boolean; is_certified?: boolean; description?: string; slug?: string; created_at?: string; updated_at?: string; [key: string]: unknown }
