...
export interface Invoice { id: number; invoice_number?: string; customer_id?: number; vehicle_id?: number; amount?: string | number; currency?: string; status?: string; due_date?: string; paid_amount?: string | number; line_items?: Array<{ description?: string; quantity?: number; unit_price?: string | number; total?: string | number }>; taxes?: string | number; discounts?: string | number; customer?: CustomerRecord; vehicle?: PaymentVehicle; payments?: Payment[]; created_at?: string; updated_at?: string; [key: string]: unknown }
export interface Receipt { id: number; receipt_number?: string; payment_id?: number; customer_id?: number; amount?: string | number; currency?: string; payment_method?: string; issued_at?: string; customer?: CustomerRecord; payment?: Payment; created_at?: string; updated_at?: string; [key: string]: unknown }
